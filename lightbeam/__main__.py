...
def main(argv=None):
    ...
    try:
        lb = Lightbeam(args.config_file, args.params, args.older_than, args.newer_than, args.retry_status_codes)
        lb.dispatch(args.selector)
